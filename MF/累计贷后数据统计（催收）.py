...
# mailto_list = ['liym@51jnq.com','luws@51jnq.com','fangjl@51jnq.com','zhoushibin@51jnq.com'
# ,'wangdy@51jnq.com','licy@51jnq.com','zhanghongfang@51jnq.com','zhanghf@51jnq.com']
mailto_list=['zhoushibin@51jnq.com']

mail_host="smtp.mxhichina.com"  #设置服务器
mail_user="system@51jnq.com"  #用户名
mail_pass="Mzf123456"   #口令


#mail_cc = [ 'zhoushibin@51jnq.com']
mail_cc = ['liym@51jnq.com']
...
if __name__ == '__main__':
    # 连接mysql
    conn = pymysql.connect(db="bmdb", user="mfuser", passwd="mf0317123456!@#$", host="598f25c0d660f.sh.cdb.myqcloud.com", port=5491) 
    cursor = conn.cursor()
